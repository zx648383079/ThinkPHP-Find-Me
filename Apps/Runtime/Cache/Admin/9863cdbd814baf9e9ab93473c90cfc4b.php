	 ...
	 <div class="container">
		 ...
		 <div class="form">
			 ...
			 <form action="<?php echo U('login/postlogin','','');?>" method="POST">
				 ...
				 <div class="row">
				 	<input class="wow fadeInRight col-lg-5" data-wow-delay="0.5s" type="text" name="verify" placeholder="验证码" required/>
				 	<div class="col-lg-6">
					 	<img id="code" style="height:50px;" src="<?php echo U('login/verify','','');?>" alt="刷新验证码"/>
				 	</div>
				 </div>
				 <div class="row">
				 	<input class="wow fadeInLeft col-md-5 col-md-offset-2" data-wow-delay="0.5s" type="submit" value="登录"/>
					<h1>
...
<script type="text/javascript">
	$(document).ready(function() { 
	  $("#code").click(function() { 
	  		$("#code").attr("src","<?php echo U('login/verify','','');?>"+"/"+Math.random());
	   } );
	 } );
</script>
